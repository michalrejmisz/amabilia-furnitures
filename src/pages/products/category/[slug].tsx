    ...
    return (
        <Fragment>
            <NextSeo
                ...
                description={`${categoryName} > Meble poleasingowe w niskiej cenie. Zapewniamy wysoką jakość.`}
                canonical={`https://amabilia-meble.pl/products/category/${slug}`}
                openGraph={{
                    url: `https://amabilia-meble.pl/products/category/${slug}`,
                    title: `${categoryName} | Amabilia-meble.pl`,
                    description: `${categoryName} > Meble poleasingowe w niskiej cenie. Zapewniamy wysoką jakość.`,
                }}
            />
