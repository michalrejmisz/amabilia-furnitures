...
import {IconChevronDown, IconChevronUp, IconTrash, IconCheck, IconX} from "@tabler/icons";
...
export const Item = ({item, slug, quantity} : CartItemProps) => {
    ...
    // const {data: products} = useQuery(PRODUCTS_ALL);
    ...
    return(
        <div className={classes.entireItem}>
                ...
                {/*<Link href={{ pathname: `/product/${slug}` }} legacyBehavior className={classes.img}>*/}
                {/*    <a>*/}
                ...
                {!isConfirming ? (
                    ...
                    <div className={classes.bin}>
                        <ActionIcon onClick={handleRemove}>
                            <IconCheck size={iconSize} stroke={1.5} color={theme.colors.green[4]}/>
                        </ActionIcon>
                        <ActionIcon onClick={handleCancel}>
                            <IconX size={iconSize} stroke={1.5} color={theme.colors.red[4]}/>
                        </ActionIcon>
                    </div>
                )}
        </div>
