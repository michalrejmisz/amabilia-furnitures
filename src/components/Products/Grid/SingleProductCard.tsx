...
import { IconGasStation, IconShoppingCart, IconSearch } from '@tabler/icons'
...
export const SingleProductCard: React.FC<{ product: IProduct }> = ({
    product,
}) => {
    ...
    return (
        <>
            <Modal opened={opened} onClose={() => setOpened(false)} size={1200}>
                <ProductComponent
                    product={{
                        ...product,
                        images: [...otherImages],
            ...
            <Card withBorder className={classes.card}>
                ...
                <Card.Section className={classes.hoverBox}>
                    ...
                    <UnstyledButton
                        onClick={() =>
                            increaseCartQuantity(product.slug, product.price)
                        }
                    >
                        <Center className={classes.hoverCart}>
                            <IconShoppingCart size={35} stroke={1.5} /> Dodaj do
                            koszyka
                        </Center>
                    </UnstyledButton>
                </Card.Section>
                ...
                <Card.Section className={classes.title}>
                    <div>
                        <Text weight={500} className={classes.titleWrap}>
                            {product.title}
                        </Text>
                    </div>
