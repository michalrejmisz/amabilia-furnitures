...
const Logo = () => {
    ...
    return(
        <Fragment>
                <img src ="/newLogo.webp" className={classes.logo} style={{width: "55px"}} alt="Logo firmy"/>
                {/*<svg className={classes.logo} id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 108.34" fill="white">*/}
