            ...
            <ol className={classes.ol} type="I">
                <li>
                    ...
                    <ol>
                        <li className="label">
                            ...
                            www.amabilia-meble.pl (dalej: Serwis).
                        </li>
                        <li className="label">
                ...
                <li>
                    ...
                    <ol style={{ listStyleType: 'none' }}>
                        <li className="label">
                            ...
                            Serwis jest Aleksandra Dolczewska , adres: Pokrzywno
                            4 w Poznaniu, KRS: 0000961122, NIP: 7822908278,
                            REGON: 521500624, adres poczty elektronicznej:
                            amabilia.poznan@gmail.com (dalej: Administrator).
                        </li>
                    </ol>
                </li>
                ...
                <li>
                    ...
                    <ol>
                        <li className="label">
                            ...
                            <ul>
                                <li className="label">
                                    rejestracji konta i weryfikacji tożsamości
                                    Użytkownika,
                                </li>
                                <li className="label">
                ...
                <li>
                    ...
                    <ol style={{ listStyleType: 'none' }}>
                        <li className="label">
                            ...
                            Użytkownika: imię i nazwisko, data urodzenia, adres
                ...
                <li>
                    ...
                    <ol style={{ listStyleType: 'none' }}>
                        ...
                        <li className="label">
                            ...
                            a dla roszczeń o świadczenia okresowe i roszczeń
                            dotyczących prowadzenia działalności gospodarczej –
                            3 lata (jeśli przepis szczególny nie stanowi
                            inaczej).
                        </li>
                    </ol>
                </li>
                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li className="label">
                            Dane osobowe Użytkowników nie będą przekazywane poza
                ...
                <li>
                    ...
                    <ol>
                        <li className="label">
                            Użytkownik Serwisu ma prawo do: dostępu do treści
                            swoich danych osobowych, ich sprostowania,
                            usunięcia, ograniczenia przetwarzania, przenoszenia,
                            wniesienia sprzeciwu wobec przetwarzania, cofnięcia
                            zgody w każdej chwili (co nie ma wpływu na zgodność
                            z prawem przetwarzania dokonanego w oparciu o zgodę
                            przed jej cofnięciem).
                        </li>
                        <li className="label">
                            Zgłoszenie o wystąpieniu przez Użytkownika z
                            uprawnieniem wynikającym z wymienionych praw należy
                            przesłać na adres amabilia.poznan@gmail.com.
                        </li>
                        <li className="label">
                            Administrator spełnia lub odmawia spełnienia żądania
                            niezwłocznie – maksymalnie w ciągu miesiąca od jego
                            otrzymania.
                        </li>
                        <li className="label">
                            Użytkownik ma prawo złożyć skargę do Prezesa Urzędu
                            Ochrony Danych Osobowych, jeśli uzna, że
                ...
                <li>
                    ...
                    <ol>
                        <li className="label">
                            Serwis zbiera informacje za pomocą plików cookies –
                            sesyjnych, stałych i podmiotów zewnętrznych.
                        </li>
                        <li className="label">
                ...
                <li>
                    ...
                    <ol>
                        <li className="label">
                            ...
                            Polityce prywatności, przy czym prawa Użytkowników
                        ...
                        <li className="label">
                            W sprawach nieuregulowanych w niniejszej Polityce
                            prywatności obowiązują przepisy RODO i przepisy
                            prawa polskiego.
                        </li>
                    </ol>
                </li>
