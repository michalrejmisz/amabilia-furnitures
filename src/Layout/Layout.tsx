...
export const Layout = ({ children }: Props) => {
    ...
    const links = [
        ...
        { link: () => handleMapClick(), label: 'Dojazd' },
        {
            link:
                '/products/category/' +
                menu?.stronaTytulowaZdjecieBiurkaInformacje?.data?.attributes
                    ?.kat?.data?.attributes?.Link,
            label: 'Produkty',
        },
    ]
            ...
            <LoadingScreen isLoading={isLoading}>
                ...
                {React.Children.map(children, (child) => {
                    return React.cloneElement(child, {
                        handleScrollToFooter: handleFooterClick,
                    })
                })}
                {/*{children}*/}
                ...
                >
                    ...
                    wykorzystywanie przez nas plików cookies. Możesz określić
                    warunki przechowywania lub dostępu do plików cookies w
                    Twojej przeglądarce.
                </CookieConsent>
                <MobileFooter />
            </LoadingScreen>
